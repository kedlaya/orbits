...
class OrbitLookupTree():
    ...
    def stabilizer(self, mats, sub=None):
        ...
        gens = G2_gap.SmallGeneratingSet()
        selfnmats['stab'] = (order, [self.optimized_rep(g) for g in gens])
        return selfnmats['stab']
